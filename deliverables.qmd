...
To avoid any confusion about the deliverables for this course and to structure all our thoughts and efforts, we have created [a template repository](https://github.com/mlarpis/portfolio) for this course.

## What to hand in {#sec-deliv}
Fork [this template repository](https://github.com/mlarpis/portfolio) following the flow below. You'll end up with a copy of the repository template on your GitHub account, with the full course exercise and deliverable structure in the `dev` branch. The full rationale about GitHub and branching will be explained in more detail in this course. 
