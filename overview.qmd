...
## Support
We will not use the course page on Blackboard. Instead, all course materials can be found here on the course website, [https://mlarpis.github.io/markup](https://mlarpis.github.io/markup).

- For handing in assignments and deliverables, you can fork [this template repository](https://github.com/hanneoberman/markup_deliverables/tree/dev) following the flow outlined in @sec-deliv.
...
Each topic includes a lecture with tutorial elements (or a seminar) and one or more exercises. Some topics have an associated deliverable (graded assignment). 
...
### Exercises
The exercises associated with each topic allow students to gain experience with the skills in this course. The exercises are not assessed summatively (with a grade), but they may provide formative feedback to the students. After completing the exercises, students are equipped to start working on the course deliverables (graded assignments). The exercises are aimed for students to practice learning objectives c and d: ‘They can efficiently organize a reproducible programming and development process’ and ‘They can produce repositories up to the standards of international programming and coding conventions and initiatives’.
