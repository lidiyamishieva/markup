...
This week has no lecture. We discussed the flow of development with `Git` in class. You can find a 3-slide presentation exercise from week 2 [here](slides/lec-3.html)
